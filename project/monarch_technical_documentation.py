...
# Generation date: 2022-12-01T11:25:04
...
class Resource(YAMLRoot):
    ...
    grant: Optional[Union[str, "GrantEnum"]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.grant is not None and not isinstance(self.grant, GrantEnum):
            self.grant = GrantEnum(self.grant)
...
class DataAsset(Resource):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.download is not None and not isinstance(self.download, str):
            self.download = str(self.download)
...
class ResourceRegistry(Resource):
    ...
    data: Optional[Union[Union[str, DataAssetId], List[Union[str, DataAssetId]]]] = empty_list()
    standards: Optional[Union[Union[str, DataAssetId], List[Union[str, DataAssetId]]]] = empty_list()
    tools: Optional[Union[Union[str, DataAssetId], List[Union[str, DataAssetId]]]] = empty_list()
    documentation: Optional[Union[Union[str, DocumentationId], List[Union[str, DocumentationId]]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.data = [v if isinstance(v, DataAssetId) else DataAssetId(v) for v in self.data]

        if not isinstance(self.standards, list):
            self.standards = [self.standards] if self.standards is not None else []
        self.standards = [v if isinstance(v, DataAssetId) else DataAssetId(v) for v in self.standards]

        if not isinstance(self.tools, list):
            self.tools = [self.tools] if self.tools is not None else []
        self.tools = [v if isinstance(v, DataAssetId) else DataAssetId(v) for v in self.tools]

        if not isinstance(self.documentation, list):
            self.documentation = [self.documentation] if self.documentation is not None else []
        self.documentation = [v if isinstance(v, DocumentationId) else DocumentationId(v) for v in self.documentation]
...
slots.grant = Slot(uri=MTD.grant, name="grant", curie=MTD.curie('grant'),
                   model_uri=MTD.grant, domain=None, range=Optional[Union[str, "GrantEnum"]])
...
slots.repository = Slot(uri=MTD.repository, name="repository", curie=MTD.curie('repository'),
                   model_uri=MTD.repository, domain=None, range=Optional[Union[str, URI]])
...
slots.url = Slot(uri=MTD.url, name="url", curie=MTD.curie('url'),
                   model_uri=MTD.url, domain=None, range=Optional[Union[str, URI]])
...
slots.documentation = Slot(uri=MTD.documentation, name="documentation", curie=MTD.curie('documentation'),
                   model_uri=MTD.documentation, domain=None, range=Optional[Union[str, URI]])
...
slots.dataAsset__download = Slot(uri=MTD.download, name="dataAsset__download", curie=MTD.curie('download'),
                   model_uri=MTD.dataAsset__download, domain=None, range=Optional[str])

slots.dataAsset__category = Slot(uri=MTD.category, name="dataAsset__category", curie=MTD.curie('category'),
                   model_uri=MTD.dataAsset__category, domain=None, range=Optional[Union[str, "DataAssetEnum"]])

slots.standard__category = Slot(uri=MTD.category, name="standard__category", curie=MTD.curie('category'),
                   model_uri=MTD.standard__category, domain=None, range=Optional[Union[str, "StandardEnum"]])

slots.resourceRegistry__data = Slot(uri=MTD.data, name="resourceRegistry__data", curie=MTD.curie('data'),
                   model_uri=MTD.resourceRegistry__data, domain=None, range=Optional[Union[Union[str, DataAssetId], List[Union[str, DataAssetId]]]])

slots.resourceRegistry__standards = Slot(uri=MTD.standards, name="resourceRegistry__standards", curie=MTD.curie('standards'),
                   model_uri=MTD.resourceRegistry__standards, domain=None, range=Optional[Union[Union[str, DataAssetId], List[Union[str, DataAssetId]]]])

slots.resourceRegistry__tools = Slot(uri=MTD.tools, name="resourceRegistry__tools", curie=MTD.curie('tools'),
                   model_uri=MTD.resourceRegistry__tools, domain=None, range=Optional[Union[Union[str, DataAssetId], List[Union[str, DataAssetId]]]])

slots.resourceRegistry__documentation = Slot(uri=MTD.documentation, name="resourceRegistry__documentation", curie=MTD.curie('documentation'),
                   model_uri=MTD.resourceRegistry__documentation, domain=None, range=Optional[Union[Union[str, DocumentationId], List[Union[str, DocumentationId]]]])
